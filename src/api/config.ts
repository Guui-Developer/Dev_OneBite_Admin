...
export const PUBLIC_API_BASE_URL = `${import.meta.env.VITE_PUBLIC_API_URL}/${API_STAGE}`;
export const ADMIN_API_BASE_URL = `${import.meta.env.VITE_ADMIN_API_URL}/${API_STAGE}`;
